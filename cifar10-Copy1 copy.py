...
if __name__ == '__main__':
    ...
    trainset = torchvision.datasets.ImageFolder('./data/CIFAR10/with_trigger/train/', transform=transform_train)
    ...
    if args.watermarkType == "unrelated":
        watermarkset = torchvision.datasets.ImageFolder('./data/CIFAR10/with_trigger/trigger_unrelated/', transform=transform_test)
    else:
