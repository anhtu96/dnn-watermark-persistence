...
if __name__ == '__main__':
    ...
    trainset = torchvision.datasets.ImageFolder('./data/CIFAR10/with_trigger/train_incre/', transform=transform_train)
    testset = torchvision.datasets.ImageFolder('./data/CIFAR10/test', transform=transform_test)
    if args.watermarkType == "unrelated":
        watermarkset = torchvision.datasets.ImageFolder('./data/CIFAR10/with_trigger/trigger_unrelated/', transform=transform_train)
    else:
    ...
    ##### Attack ####
    net_attacked = eval(f"test_{args.attack}")(args, net, loaders)
    ...
    torch.save(net_attacked.state_dict(), f"models/attacked_{args.attack}.pth")
